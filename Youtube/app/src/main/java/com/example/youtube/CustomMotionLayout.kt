...
class CustomMotionLayout(context: Context, attributeSet: AttributeSet? = null): MotionLayout(context, attributeSet) {
  ...
  private val gestureListner by lazy { object: GestureDetector.SimpleOnGestureListener() {
